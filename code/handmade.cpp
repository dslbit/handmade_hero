	    ...
	    ++RelRow)
	{
		    ...
		    ++RelColumn)
		{
			...
			if(TileID > 1)
			{
				...
				real32 CenX = ScreenCenterX - MetersToPixel * GameState->PlayerP.OffsetX + ((real32) RelColumn * TileSideInPixels);
				real32 CenY = ScreenCenterY + MetersToPixel * GameState->PlayerP.OffsetY - ((real32) RelRow * TileSideInPixels);
