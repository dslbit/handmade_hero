...
{
	// TODO(Douglas): Esse arquivo precisa ir para uma pasta temporário/debug
	// TODO(Douglas): Talvez no futuro escrever esse arquivo no disco (devagar) e manter uma cópia na memória
